...
void NOpenGLWidget::initializeGL()
{
    ...
    //
    m_RefractionShaderProgram.addShaderFromSourceFile(QOpenGLShader::Vertex, ":/shaders/refraction.vert");
    m_RefractionShaderProgram.addShaderFromSourceFile(QOpenGLShader::Fragment, ":/shaders/refraction.frag");
    success = m_RefractionShaderProgram.link();
    if (!success) qDebug() << "Error:" << m_RefractionShaderProgram.log();
