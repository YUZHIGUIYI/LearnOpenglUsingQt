...
void NOpenGLWidget::initializeGL()
{
    ...
    //
    m_ReflectionShaderProgram.addShaderFromSourceFile(QOpenGLShader::Vertex, ":/shaders/reflection.vert");
    m_ReflectionShaderProgram.addShaderFromSourceFile(QOpenGLShader::Fragment, ":/shaders/reflection.frag");
    success = m_ReflectionShaderProgram.link();
    if (!success) qDebug() << "Error:" << m_ReflectionShaderProgram.log();
