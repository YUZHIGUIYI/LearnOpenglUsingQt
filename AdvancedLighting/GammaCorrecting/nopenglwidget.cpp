...
QVector3D viewInitPos = QVector3D(0.0f, 1.0f, 4.0f);
...
void NOpenGLWidget::initializeGL()
{
    ...
    m_PlaneDiffuseTex = new QOpenGLTexture(QOpenGLTexture::Target2D);
    glBindTexture(GL_TEXTURE_2D, m_PlaneDiffuseTex->textureId());  // 绑定
