...
void Mesh::Draw(QOpenGLShaderProgram &shader)
{
    ...
    for (unsigned int i = 0; i < textures.size(); i++) {
        ...
        //m_glFuns->glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_MIRRORED_REPEAT);
        //m_glFuns->glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_MIRRORED_REPEAT);
...
Mesh::Mesh(QOpenGLFunctions_4_5_Core *glFuns, vector<Vertex> vertices, vector<unsigned int> indices, vector<Texture> textures)
    : m_glFuns(glFuns)
{
    // 构造函数与初始化
